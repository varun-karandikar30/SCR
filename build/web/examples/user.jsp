...
<%
    ...
    String gpa = (String) session.getAttribute("gpa");
			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="user.jsp">Profile</a>
					</div>
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<!-- <li class="dropdown">
								<a href="#notif" class="dropdown-toggle" data-toggle="dropdown">
	                                    ...
	                                    <div class="row">
	                                        ...
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													<label class="control-label">Enrolment No.</label>
                                                                                                        <input type="text" name="eno" value="<%=eno%>" class="form-control" >
												</div>
	                                        </div>
	                                        <div class="col-md-4">
												<div class="form-group label-floating">
	                                     ...
	                                     <div class="row">
	                                        ...
	                                        <div class="col-md-4">
												<div class="form-group label-floating">
													...
													<input type="text" name="gpa" value="<%=gpa%>" class="form-control" >
												</div>
	                                        </div>
	                                     	<div class="col-md-4">
												<div class="form-group label-floating">
	                                    ...
	                                    <div class="row">
	                                        <div class="col-md-12">
												<div class="form-group label-floating">
													...
													<input type="text" name="skills" value="<%=skills%>" class="form-control" data-role="tagsinput" />
												</div>
	                                        </div>
	                                     </div>
	                                    <div class="row">
	                                        <div class="col-md-12">
	                                            <div class="form-group">
													<div class="form-group label-floating">
									    				<label class="control-label"> Tell us something about yourself.</label>
							...
							<form action="../Image" method="Post" enctype="multipart/form-data">
    							<div class="card card-profile">
    								<div class="card-avatar">
    									<a href="#pablo">
    									<img class="img" src="image.jsp?imgid=<%=email%>" id="blah"/>
    									</a>
    								</div>
